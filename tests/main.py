...
Value "all" is used for running all tests. Following parameters are required:
    ...
    Example:
    python main.py --type all --with-authentication --authentication-address http://127.0.0.1:5002 --jwt-secret backupkey117 --roles-field role --administrator-role admin --customer-role customer --warehouse-role worker --customer-address http://127.0.0.1:5001 --warehouse-address http://127.0.0.1:5003 --administrator-address http://127.0.0.1:5000
""";
